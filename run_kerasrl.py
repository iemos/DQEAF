...
_, model1, _, _ = train_dqn_model_EpsGreedy_Policy([512, 128], rounds=rounds)  # black box
...
_, model2, _, _ = train_dqn_model_EpsGreedy_Policy([512, 128], rounds=rounds, use_score=True)  # score
